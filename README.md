...
**▶ 설치 없이 바로 보기 — [만든 사람이 어떻게 검증했는지](https://ae-gyeongwon.github.io/codebase-rag-assistant/)** · 무엇을 재고 무엇을 정했는지 8장짜리 기록
...
**대신 일반적인 용어 설명은 하지 않습니다.** 여기 적혀 있는 것은 개념이 아니라
**무엇을 왜 그렇게 정했는지의 기록**이고, 그 기록에 없는 말은 모른다고 답합니다.
이 경계를 실제로 재 보고 나서야 화면에 적었습니다 → [노트 #30](docs/engineering-notes.md#30-평가셋이-실제-질문보다-쉬웠다--그런데-그걸-재려던-첫-비교부터-틀렸다)
...
- 내가 만든 문항이 **실제 질문보다 쉬웠던 것은 아닌가** — 실제로 쉬웠습니다(85% → 50%)

**이 저장소에서 실제로 시간을 쓴 곳은 그 의심을 하나씩 확인한 기록입니다.**
그러다 **세 번은 제 진단이 틀렸다는 것**도 확인했고, 틀린 자리를 지우지 않고 남겼습니다.

## 재고 정한 것 — `/eval`

### 👉 [지금 바로 열어 보기 — 만든 사람이 어떻게 검증했는지](https://ae-gyeongwon.github.io/codebase-rag-assistant/)

설치도 실행도 필요 없습니다. **무엇을 재고 무엇을 정했는지 8장짜리 기록**이 그대로 열립니다.
...
구현하며 마주친 문제와 해결 과정 30건은 **[엔지니어링 노트](docs/engineering-notes.md)** 에 정리.
...
docs/
  engineering-notes.md  구현 중 마주친 문제 30건
